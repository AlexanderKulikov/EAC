...
// Параметры:
//   ЗаписьXML - ЗаписьXML - объект, через которых происходит запись объектов ИБ.
//   МенеджерНабораЗаписей - РегистрСведенийМенеджер, и т.п. - менеджер регистра.
...
//     * Менеджер - КонстантыМенеджер, СправочникиМенеджер, ДокументыМенеджер, РегистрыСведенийМенеджер, и т.п. -
//     * Класс - Строка -
//     * Выгружаемый - Булево -
//     * ДляЗапроса - Строка -
