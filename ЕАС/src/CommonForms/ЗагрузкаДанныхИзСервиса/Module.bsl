...
Процедура ПродолжитьЗагрузкуДанных(ВыборВыполнен, Адрес, ВыбранноеИмяФайла, ДополнительныеПараметры) Экспорт
	...
	Если ВыгрузкаДляТехническойПоддержки(АдресХранилища) Тогда
...
&НаСервереБезКонтекста
Функция ВыгрузкаДляТехническойПоддержки(АдресХранилища)
	
	ДайджестВыгрузки = ДайджестВыгрузки(АдресХранилища); // ДокументDOM
...
&НаСервереБезКонтекста
Функция ДайджестВыгрузки(АдресХранилища) Экспорт
